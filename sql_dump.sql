...
CREATE TABLE `driver_rating` (
  ...
  KEY `fk_driver_rating_driver_id` (`driver_id`),
  KEY `fk_driver_rating_person_id` (`person_id`),
  CONSTRAINT `fk_driver_rating_driver_id` FOREIGN KEY (`driver_id`) REFERENCES `driver` (`driver_id`),
  CONSTRAINT `fk_driver_rating_person_id` FOREIGN KEY (`person_id`) REFERENCES `person` (`person_id`)
...
INSERT INTO `driver_rating` VALUES (1,2,28,5),(2,8,19,3),(3,5,126,2),(4,3,200,1),(5,5,118,3),(6,3,106,2),(7,5,181,2),(8,3,75,5),(9,4,129,5),(10,7,91,2),(11,6,80,4),(12,5,131,3),(13,5,180,5),(14,8,64,3),(15,4,134,1),(16,1,122,3),(17,6,177,3),(18,8,195,3),(19,2,167,5),(20,5,67,2);
...
CREATE TABLE `restaurant_rating` (
  ...
  KEY `fk_restaurant_rating_restaurant_id` (`restaurant_id`),
  KEY `fk_restaurant_rating_person_id` (`person_id`),
  CONSTRAINT `fk_restaurant_rating_person_id` FOREIGN KEY (`person_id`) REFERENCES `person` (`person_id`),
  CONSTRAINT `fk_restaurant_rating_restaurant_id` FOREIGN KEY (`restaurant_id`) REFERENCES `restaurant` (`restaurant_id`)
) ENGINE=InnoDB AUTO_INCREMENT=101 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `restaurant_rating` VALUES (1,83,27,1),(2,27,49,5),(3,32,75,4),(4,97,201,1),(5,34,1,1),(6,28,128,2),(7,60,115,5),(8,52,77,1),(9,87,47,5),(10,63,4,3),(11,87,201,4),(12,35,36,5),(13,24,17,4),(14,22,56,1),(15,88,7,5),(16,46,200,5),(17,30,43,5),(18,88,144,2),(19,13,17,4),(20,79,130,3);
